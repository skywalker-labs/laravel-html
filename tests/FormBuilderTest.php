...
use Skywalker\Html\HtmlBuilder;
...
class FormBuilderTest extends PHPUnit\Framework\TestCase
{
    ...
    /**
     * @var \Illuminate\Contracts\View\Factory|\Mockery\MockInterface
     */
    ...
    public function testRequestValue()
    {
        ...
        $this->assertEquals('<input name="person[name]" type="text" value="John">', (string) $name);
        $this->assertEquals('<input name="person[surname]" type="text" value="Doe">', (string) $surname);

        $checked = $this->formBuilder->checkbox("agree", 1);
        $unchecked = $this->formBuilder->checkbox("no_value", 1);
        $this->assertEquals('<input checked="checked" name="agree" type="checkbox" value="1">', (string) $checked);
        $this->assertEquals('<input name="no_value" type="checkbox" value="1">', (string) $unchecked);

        $checked_array = $this->formBuilder->checkbox("checkbox_array[]", 1);
        $unchecked_array = $this->formBuilder->checkbox("checkbox_array[]", 4);
        $this->assertEquals('<input checked="checked" name="checkbox_array[]" type="checkbox" value="1">', (string) $checked_array);
        $this->assertEquals('<input name="checkbox_array[]" type="checkbox" value="4">', (string) $unchecked_array);

        $checked = $this->formBuilder->radio("agree", 1);
        $unchecked = $this->formBuilder->radio("no_value", 1);
        $this->assertEquals('<input checked="checked" name="agree" type="radio" value="1">', (string) $checked);
        $this->assertEquals('<input name="no_value" type="radio" value="1">', (string) $unchecked);

        // now we check that Request is ignored and value take precedence
        $this->formBuilder->considerRequest(false);
        $name = $this->formBuilder->text("person[name]", "Not John");
        $surname = $this->formBuilder->text("person[surname]", "Not Doe");
        $this->assertEquals('<input name="person[name]" type="text" value="Not John">', (string) $name);
        $this->assertEquals('<input name="person[surname]" type="text" value="Not Doe">', (string) $surname);
    }
    ...
    public function testOpeningForm()
    {
        ...
        $this->assertEquals('<form method="GET" action="http://localhost/foo" accept-charset="UTF-8">', (string) $form1);
        $this->assertEquals('<form method="POST" action="http://localhost/foo" accept-charset="UTF-8" class="form" id="id-form"><input name="_token" type="hidden" value="abc">', (string) $form2);
        $this->assertEquals('<form method="GET" action="http://localhost/foo" accept-charset="UTF-16">', (string) $form3);
        $this->assertEquals('<form method="GET" action="http://localhost/foo" accept-charset="UTF-16" enctype="multipart/form-data">', (string) $form4);
        $this->assertEquals('<form method="POST" action="http://localhost/foo" accept-charset="UTF-8"><input name="_method" type="hidden" value="PUT"><input name="_token" type="hidden" value="abc">', (string) $form5);
    }
    ...
    public function testFormRoute()
    {
        ...
        $this->assertEquals('<form method="GET" action="http://localhost/user/1?foo=bar" accept-charset="UTF-8">', (string) $form1);
        $this->assertEquals('<form method="GET" action="http://localhost/user/2?foo=bar" accept-charset="UTF-8">', (string) $form2);
        $this->assertEquals('<form method="GET" action="http://localhost/user/3?foo=bar" accept-charset="UTF-8">', (string) $form3);
        $this->assertEquals('<form method="GET" action="http://localhost/user/4?foo=bar" accept-charset="UTF-8">', (string) $form4);
    }
    ...
    public function testFormLabel()
    {
        ...
        $this->assertEquals('<label for="foo">Foobar</label>', (string) $form1);
        $this->assertEquals('<label for="foo" class="control-label">Foobar</label>', (string) $form2);
        $this->assertEquals('<label for="foo">Foobar <i>bar</i></label>', (string) $form3);
    }
    ...
    public function testFormInput()
    {
        ...
        $this->assertEquals('<input name="foo" type="text">', (string) $form1);
        $this->assertEquals('<input name="foo" type="text" value="foobar">', (string) $form2);
        $this->assertEquals('<input class="span2" name="foobar" type="date">', (string) $form3);
        $this->assertEquals('<input name="foo" type="hidden" value="1">', (string) $form4);
        $this->assertEquals('<input name="foo-check" type="checkbox" value="1">', (string) $form6);
    }
    ...
    public function testMacroField()
    {
        ...
        $this->assertEquals('<input name="foo" type="text" value="" role="set_name" data-titlecase="ucfirst" data-inputmask-type="Regex" data-inputmask-regex="[A-Za-z0-9\s-\(\)&]{2,70}">', (string) $form);
    }
    ...
    public function testPasswordsNotFilled()
    {
        ...
        $this->assertEquals('<input name="password" type="password" value="">', (string) $form1);
    }
    ...
    public function testFilesNotFilled()
    {
        ...
        $this->assertEquals('<input name="img" type="file">', (string) $form);
    }
    ...
    public function testFormText()
    {
        ...
        $this->assertEquals('<input name="foo" type="text">', (string) $form1);
        $this->assertEquals((string) $form1, (string) $form2);
        $this->assertEquals('<input name="foo" type="text" value="foobar">', (string) $form3);
        $this->assertEquals('<input class="span2" name="foo" type="text">', (string) $form4);
    }
    ...
    public function testFormTextArray()
    {
        ...
        $this->assertEquals('<input name="foo[]" type="text" value="testing">', (string) $form1);
        $this->assertEquals('<input name="foo[]" type="text">', (string) $form2);
    }
    ...
    public function testFormTextRepopulation()
    {
        ...
        $session->shouldReceive('has')->with('_old_input')->andReturn(true, false, false);
        ...
        $this->assertEquals('<input name="relation[key]" type="text" value="attribute">', (string) $input1);
        $this->assertEquals((string) $input1, (string) $input2);
    }
    ...
    public function testFormRepopulationWithMixOfArraysAndObjects()
    {
        ...
        $this->assertEquals('<input name="user[password]" type="text" value="apple">', (string) $input);

        $this->formBuilder->model((object) ['letters' => ['a', 'b', 'c']]);
        $input = $this->formBuilder->text('letters[1]');
        $this->assertEquals('<input name="letters[1]" type="text" value="b">', (string) $input);
    }
    ...
    public function testFormPassword()
    {
        ...
        $this->assertEquals('<input name="foo" type="password" value="">', (string) $form1);
        $this->assertEquals('<input class="span2" name="foo" type="password" value="">', (string) $form2);
    }
    ...
    public function testFormRange()
    {
        ...
        $this->assertEquals('<input name="foo" type="range">', (string) $form1);
        $this->assertEquals('<input name="foo" type="range" value="1">', (string) $form2);
        $this->assertEquals('<input class="span2" name="foo" type="range">', (string) $form3);
    }
    ...
    public function testFormHidden()
    {
        ...
        $this->assertEquals('<input name="foo" type="hidden">', (string) $form1);
        $this->assertEquals('<input name="foo" type="hidden" value="foobar">', (string) $form2);
        $this->assertEquals('<input class="span2" name="foo" type="hidden">', (string) $form3);
    }
    ...
    public function testFormMonth()
    {
        ...
        $this->assertEquals('<input name="foo" type="month">', (string) $form1);
        $this->assertEquals('<input name="foo" type="month" value="' . \Carbon\Carbon::now()->format('Y-m') . '">', (string) $form2);
        $this->assertEquals('<input class="span2" name="foo" type="month">', (string) $form3);
    }
    ...
    public function testFormSearch()
    {
        ...
        $this->assertEquals('<input name="foo" type="search">', (string) $form1);
        $this->assertEquals('<input name="foo" type="search" value="foobar">', (string) $form2);
        $this->assertEquals('<input class="span2" name="foo" type="search">', (string) $form3);
    }
    ...
    public function testFormEmail()
    {
        ...
        $this->assertEquals('<input name="foo" type="email">', (string) $form1);
        $this->assertEquals('<input name="foo" type="email" value="foobar">', (string) $form2);
        $this->assertEquals('<input class="span2" name="foo" type="email">', (string) $form3);
    }
    ...
    public function testFormTel()
    {
        ...
        $this->assertEquals('<input name="foo" type="tel">', (string) $form1);
        $this->assertEquals('<input name="foo" type="tel" value="foobar">', (string) $form2);
        $this->assertEquals('<input class="span2" name="foo" type="tel">', (string) $form3);
    }
    ...
    public function testFormNumber()
    {
        ...
        $this->assertEquals('<input name="foo" type="number">', (string) $form1);
        $this->assertEquals('<input name="foo" type="number" value="1">', (string) $form2);
        $this->assertEquals('<input class="span2" name="foo" type="number">', (string) $form3);
    }
    ...
    public function testFormDate()
    {
        ...
        $this->assertEquals('<input name="foo" type="date">', (string) $form1);
        $this->assertEquals('<input name="foo" type="date" value="2015-02-20">', (string) $form2);
        $this->assertEquals('<input name="foo" type="date" value="' . \Carbon\Carbon::now()->format('Y-m-d') . '">', (string) $form3);
        $this->assertEquals('<input class="span2" name="foo" type="date">', (string) $form4);
    }
    ...
    public function testFormTime()
    {
        ...
        $this->assertEquals('<input name="foo" type="time">', (string) $form1);
        $this->assertEquals('<input name="foo" type="time" value="' . \Carbon\Carbon::now()->format('H:i') . '">', (string) $form2);
        $this->assertEquals('<input class="span2" name="foo" type="time">', (string) $form3);
    }
    ...
    public function testFormUrl()
    {
        ...
        $this->assertEquals('<input name="foo" type="url">', (string) $form1);
        $this->assertEquals('<input name="foo" type="url" value="http://foobar.com">', (string) $form2);
        $this->assertEquals('<input class="span2" name="foo" type="url">', (string) $form3);
    }
    ...
    public function testFormWeek()
    {
        ...
        $this->assertEquals('<input name="foo" type="week">', (string) $form1);
        $this->assertEquals('<input name="foo" type="week" value="' . \Carbon\Carbon::now()->format('Y-\WW') . '">', (string) $form2);
        $this->assertEquals('<input class="span2" name="foo" type="week">', (string) $form3);
    }
    ...
    public function testFormFile()
    {
        ...
        $this->assertEquals('<input name="foo" type="file">', (string) $form1);
        $this->assertEquals('<input class="span2" name="foo" type="file">', (string) $form2);
    }
    ...
    public function testFormTextarea()
    {
        ...
        $this->assertEquals('<textarea name="foo" cols="50" rows="10"></textarea>', (string) $form1);
        $this->assertEquals('<textarea name="foo" cols="50" rows="10">foobar</textarea>', (string) $form2);
        $this->assertEquals('<textarea class="span2" name="foo" cols="50" rows="10"></textarea>', (string) $form3);
        $this->assertEquals('<textarea name="foo" cols="60" rows="15"></textarea>', (string) $form4);
        $this->assertEquals('<textarea name="encoded_html" cols="60" rows="50">Eggs &amp; Sausage</textarea>', (string) $form5);
        $this->assertEquals('<textarea name="encoded_html" cols="60" rows="50">Eggs &amp;&amp; Sausage</textarea>', (string) $form6);
    }
    ...
    public function testSelect()
    {
        ...
        $this->assertEquals((string) $select, '<select name="select-name" id="select-name-id"></select>');
        ...
        $this->assertEquals('<select name="countries"><option value="1" selected="selected">L</option><option value="2">M</option></select>', (string) $result);

        $select = $this->formBuilder->select('avc', [1 => 'Yes', 0 => 'No'], true, ['placeholder' => 'Select']);
        $this->assertEquals('<select name="avc"><option value="">Select</option><option value="1" selected="selected">Yes</option><option value="0">No</option></select>', (string) $select);
    }
    ...
    public function testFormSelectYear()
    {
        ...
        $this->assertStringContainsString('<select name="year"><option value="2000">2000</option><option value="2001">2001</option>', (string) $select1);
        $this->assertStringContainsString('<select id="foo" name="year"><option value="2000">2000</option><option value="2001">2001</option>', (string) $select2);
        $this->assertStringContainsString('<select name="year"><option value="2000" selected="selected">2000</option><option value="2001">2001</option>', (string) $select3);
    }
    ...
    public function testFormSelectRange()
    {
        ...
        $this->assertStringContainsString('<select name="dob"><option value="1900">1900</option>', (string) $range);
        $this->assertStringContainsString('<option value="2013">2013</option>', (string) $range);
    }
    ...
    public function testFormSelectMonth()
    {
        ...
        $this->assertStringContainsString('<select name="month"><option value="1">January</option><option value="2">February</option>', (string) $month1);
        $this->assertStringContainsString('<select name="month"><option value="1" selected="selected">January</option>', (string) $month2);
        $this->assertStringContainsString('<select id="foo" name="month"><option value="1">January</option>', (string) $month3);
    }
    ...
    public function testFormCheckbox()
    {
        ...
        $session->shouldReceive('get')->with('_old_input', [])->andReturn(['foo' => null]);
        ...
        $this->assertEquals('<input name="foo" type="checkbox">', (string) $form1);
        $this->assertEquals('<input name="foo" type="checkbox" value="1">', (string) $form2);
        $this->assertEquals('<input checked="checked" name="foo" type="checkbox" value="foobar">', (string) $form3);
        $this->assertEquals('<input class="span2" name="foo" type="checkbox" value="foobar">', (string) $form4);
    }
    ...
    public function testFormCheckboxRepopulation()
    {
        ...
        $this->assertEquals('<input checked="checked" name="multicheck[]" type="checkbox" value="1">', (string) $check1);
        $this->assertEquals('<input name="multicheck[]" type="checkbox" value="2">', (string) $check2);
        $this->assertEquals('<input checked="checked" name="multicheck[]" type="checkbox" value="3">', (string) $check3);
    }
    ...
    public function testFormCheckboxWithModelRelation()
    {
        ...
        $this->assertEquals('<input name="items[]" type="checkbox" value="1">', (string) $check1);
        $this->assertEquals('<input checked="checked" name="items[]" type="checkbox" value="2">', (string) $check2);
        $this->assertEquals('<input name="items[]" type="checkbox" value="3">', (string) $check3);
        $this->assertEquals('<input checked="checked" name="items[]" type="checkbox" value="4">', (string) $check4);
    }
    ...
    public function testFormCheckboxWithoutSession()
    {
        ...
        $this->assertEquals('<input name="foo" type="checkbox" value="1">', (string) $form1);
        $this->assertEquals('<input checked="checked" name="foo" type="checkbox" value="foobar">', (string) $form2);
    }
    ...
    public function testFormRadio()
    {
        ...
        $this->assertEquals('<input name="foo" type="radio">', (string) $form1);
        $this->assertEquals('<input name="foo" type="radio" value="foo">', (string) $form2);
        $this->assertEquals('<input checked="checked" name="foo" type="radio" value="foobar">', (string) $form3);
        $this->assertEquals('<input class="span2" name="foo" type="radio" value="foobar">', (string) $form4);
    }
    ...
    public function testFormRadioWithAttributeCastToBoolean()
    {
        ...
        $this->assertEquals('<input checked="checked" name="itemA" type="radio" value="1">', (string) $radio1);
        $this->assertEquals('<input name="itemA" type="radio" value="0">', (string) $radio2);
        $this->assertEquals('<input name="itemB" type="radio" value="1">', (string) $radio3);
        $this->assertEquals('<input checked="checked" name="itemB" type="radio" value="0">', (string) $radio4);
    }
    ...
    public function testFormRadioRepopulation()
    {
        ...
        $session->shouldReceive('get')->with('_old_input', [])->andReturn(['radio' => 1]);

        $radio1 = $this->formBuilder->radio('radio', 1);
        $radio2 = $this->formBuilder->radio('radio', 2, true);

        $this->assertEquals('<input checked="checked" name="radio" type="radio" value="1">', (string) $radio1);
        $this->assertEquals('<input name="radio" type="radio" value="2">', (string) $radio2);
    }
    ...
    public function testFormSubmit()
    {
        ...
        $this->assertEquals('<input type="submit" value="foo">', (string) $form1);
        $this->assertEquals('<input class="span2" type="submit" value="foo">', (string) $form2);
    }
    ...
    public function testFormButton()
    {
        ...
        $this->assertEquals('<button type="button">foo</button>', (string) $form1);
        $this->assertEquals('<button class="span2" type="button">foo</button>', (string) $form2);
    }

    public function testResetInput()
    {
        $resetInput = $this->formBuilder->reset('foo');
        $this->assertEquals('<input type="reset" value="foo">', (string) $resetInput);
    }
    ...
    public function testImageInput()
    {
        ...
        $this->assertEquals('<input src="' . $url . '" type="image">', (string) $image);
    }
    ...
    public function testFormColor()
    {
        ...
        $this->assertEquals('<input name="foo" type="color">', (string) $form1);
        $this->assertEquals('<input name="foo" type="color" value="#ff0000">', (string) $form2);
        $this->assertEquals('<input class="span2" name="foo" type="color">', (string) $form3);
    }
    ...
    public function testDatalist()
    {
        ...
        $this->assertEquals('<datalist id="genders"><option value="M">Male</option><option value="F">Female</option></datalist>', (string) $datalist);

        // Associative array with numeric Keys
        $genders = [5 => 'Male', 6 => 'Female'];
        $datalist = $this->formBuilder->datalist('genders', $genders);
        $this->assertEquals('<datalist id="genders"><option value="5">Male</option><option value="6">Female</option></datalist>', (string) $datalist);

        // Not associative array.
        $genders = ['Male', 'Female'];
        $datalist = $this->formBuilder->datalist('genders', $genders);
        $this->assertEquals('<datalist id="genders"><option value="Male">Male</option><option value="Female">Female</option></datalist>', (string) $datalist);
    }

    public function testBooleanAttributes()
    {
        $input = $this->formBuilder->text('test', null, ['disabled']);
        $this->assertEquals('<input disabled name="test" type="text">', (string) $input);

        $input = $this->formBuilder->textarea('test', null, ['readonly']);
        $this->assertEquals('<textarea readonly name="test" cols="50" rows="10"></textarea>', (string) $input);
    }

    public function testArrayClassAttributes()
    {
        $input = $this->formBuilder->text('test', null, ['class' => ['class-a', 'class-b']]);
        $this->assertEquals('<input class="class-a class-b" name="test" type="text">', (string) $input);

        $input = $this->formBuilder->text('test', null, ['class' => [
            'class-a',
            false ? 'class-b' : 'class-c'
        ]]);
        $this->assertEquals('<input class="class-a class-c" name="test" type="text">', (string) $input);
    }
    ...
    {
        $honeypot = (string) $this->formBuilder->honeypot('my_name', 'my_time');

        $this->assertStringContainsString('<div style="display:none;">', $honeypot, 'Div wrapper missing');
        $this->assertStringContainsString('name="my_name"', $honeypot, 'Name attribute missing');
        $this->assertStringContainsString('id="my_name"', $honeypot, 'ID attribute missing');
        $this->assertStringContainsString('tabindex="-1"', $honeypot, 'Tabindex missing');
        $this->assertStringContainsString('autocomplete="off"', $honeypot, 'Autocomplete missing');
        $this->assertStringContainsString('type="text"', $honeypot, 'Type text missing');
        $this->assertStringContainsString('name="my_time"', $honeypot, 'Time name missing');
    }
}
